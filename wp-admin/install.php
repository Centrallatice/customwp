...
function display_setup_form( $error = null ) {
	...
	$weblog_title = isset( $_POST['weblog_title'] ) ? trim( wp_unslash( $_POST['weblog_title'] ) ) : WP_DEFAULT_TITLE;
	$user_name = isset($_POST['user_name']) ? trim( wp_unslash( $_POST['user_name'] ) ) : 'sylvain@seeyoucloud.com';
	$admin_email  = isset( $_POST['admin_email']  ) ? trim( wp_unslash( $_POST['admin_email'] ) ) : 'sylvain@seeyoucloud.com';
...
<form id="setup" method="post" action="install.php?step=2" novalidate="novalidate">
	<table class="form-table">
		<tr>
			...
			<td><input name="weblog_title" type="text" id="weblog_title" size="25" value="SYC - <?php echo esc_attr( $weblog_title ); ?>" /></td>
		</tr>
		<tr>
